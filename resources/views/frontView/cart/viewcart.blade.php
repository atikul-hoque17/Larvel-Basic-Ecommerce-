...
.product-line-price { float: right; width: 12%; text-align: left; }
...
div#clmn_lebel_product {
    float: left;
    width: 40%;
}
div#clmn_lebel_price {
    float: left;
    width: 10%;
}
div#clmn_lebel_quantity {
    float: left;
    width: 15%;
}
div#clmn_lebel_remove {
    float: left;
    width: 24%;
}
div#clmn_lebel_total {
    float: left;
    width: 10%;
}
.product {
...
.product-line-price {
    ...
    width: 100%;
    margin-top: 10px;
    text-align: right;background: #f7f7f7;padding-right: 20px;
}
.product-quantity {
    width: 25%;
}
...
<div id="shopping_chart_page">
  ...
  <div id="empty_cart"><a style="padding: 5px;color: #fff;font-weight: bold;float: right;width: auto;margin-bottom: 5px" href="javascript:void(0)" id="delete-product" data-id="" class="empty_Cart btn btn-danger">Empty Cart</i></a></div>
  ...
  <div id="shopping_cart">
                          ...
                          <div class="column-labels">
                            <div id="clmn_lebel_product"><label class="product-image">Product</label></div>
                            <div id="clmn_lebel_price"><label class="product-Price">Price</label></div>
                            <div id="clmn_lebel_quantity"><label class="product-Quantity">Quantity</label></div>
                            <div id="clmn_lebel_remove"><label class="product-Quantity">Remove</label></div>                           
                            <div id="clmn_lebel_total"><label class="product-Total">Total</label></div>
                                <!-- <label class="product-image">Total</label> -->
