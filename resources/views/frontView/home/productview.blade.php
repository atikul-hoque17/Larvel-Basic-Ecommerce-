...
<link href="{{ asset('public/frontend') }}/css/bootstrap.css" rel="stylesheet" type="text/css" media="all" /><!-- pignose css -->
          ...
          <div class="product-details">
            <div class="product-left">
              ...
              <div class="product-image">
                ...
                <img src="{{ asset('public/') }}/{{ ($productsbyId->pic) }}" >
              </div>
            </div>
            ...
            <div class="product-right">
             ...
             <div class="product-quantity">
              ...
              <div class="product-quantity">
                ...
                <div>
                  <input type="number"  id="product-quantity-input" placeholder="0" value="1" disabled="">
                </div>
              ...
              <div class="item-info-product ">
                ...
                <a  class="addcart single-item hvr-outline-out button2" href="{{ url('/add/cart/'. $productsbyId->id) }}">Add to cart</a>  <br>
               
           

                

              <!--  <a href="javascript:void(0)" id="delete-product" data-id="{{ $productsbyId->id }}" class="add_cart">Add Cart</i></a>
                -->
	          </div>
            </div>
